function enterSite(){
  ...
  $("#full-site").css("overflow-y","scroll");   // visible
  $("#full-site").css("max-height","auto");

  $("#register-side-bar").css("transform","translate(1390px)");
}

$("#visible-section").mouseenter( function(){ openForm(); });
$("#empty-section").mouseleave(function(){ closeForm(); });
$("#form-section").mouseleave(function(){ closeForm(); });

function openForm(){
  $("#register-side-bar").css("transform","translate(800px)");
...
function closeForm(){
  $("#register-side-bar").css("transform","translate(1400px)");
